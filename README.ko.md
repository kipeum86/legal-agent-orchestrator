...
| **반성문 (Ban Seong-mun)** · *파트너* | [second-review-agent](https://github.com/lowtidebuild/second-review-agent) | AI 생성 법률 문서 최종 품질 게이트. 인용을 **여러 primary legal database**(law.go.kr, congress.gov, eur-lex 등)에 대해 verbatim 대조하고, 법적 논리와 작성 품질을 점검하며, tracked change가 들어간 redlined DOCX를 생성합니다. 독립 release 게이트(Pass / Pass with Warnings / Manual Review Required / Not Recommended). 환각 인용 zero tolerance. | Phase 1 ✓ |
...
commercial legal AI product는 블랙박스입니다. 답은 받지만 어떻게 나왔는지 알 수 없습니다.
