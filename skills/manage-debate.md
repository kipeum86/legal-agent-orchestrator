...
`{{STYLE_GUIDE_BLOCK}}`와 `{{ERROR_CONTRACT_BLOCK}}`는 [skills/route-case.md](/Users/user/코딩%20프로젝트/legal-agent-orchestrator/skills/route-case.md)의 Step 8.0 정의를 그대로 사용합니다.
...
Round 1은 Pattern 1과 동일한 방식으로 **동시에** 2개 에이전트를 호출합니다. 호출 프로토콜과 `source_graded` 이벤트 로깅은 [CLAUDE.md](/Users/user/코딩%20프로젝트/legal-agent-orchestrator/CLAUDE.md) Step 3을 따릅니다.
...
토론 종료 이벤트를 기록한 뒤 [skills/deliver-output.md](/Users/user/코딩%20프로젝트/legal-agent-orchestrator/skills/deliver-output.md)를 Read하고 그대로 따릅니다.
